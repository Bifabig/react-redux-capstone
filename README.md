...
# 📖 Stocks <a name="about-project"></a>

<!-- > Describe your project in 1 or 2 sentences. -->

**Stocks** is a mobile application that fetches balance sheet data for certain stocks from an API.
...
- <a href="https://649fea9d8cd57a0c58cb1cbc--balancesheet-biftu.netlify.app/">Space Travelers' Hub Live</a>
...
```sh
  cd my-folder
  git clone https://github.com/Bifabig/react-redux-capstone.git
```
